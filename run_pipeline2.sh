...
# => all running positron

# ./run_pipeline2.sh LG2_40kb TCGAluad_norm_luad   #  
# ./run_pipeline2.sh LG2_40kb TCGAluad_mutKRAS_mutEGFR 
# ./run_pipeline2.sh LG2_40kb TCGAluad_nonsmoker_smoker
# ./run_pipeline2.sh LG2_40kb TCGAluad_wt_mutKRAS # 
# ./run_pipeline2.sh LG2_40kb TCGAlusc_norm_lusc  # 
...
#TAD_DE_pipSteps=( "0cleanInputTCGAminCount"  "1cleanInputTCGAminCount" ) #"3" "4" "5fastSavePermut" "6fastSave" "5sameNbr" "9" "7sameNbr" "10sameNbrTopDom" "11sameNbr" "8cOnlyRatioDownFastSave" "19onlyFC" "19sameNbr" ) 
TAD_DE_pipSteps=( "3" "4" "5fastSavePermut" "6fastSave" "5sameNbr" "9" "7sameNbr" "10sameNbrTopDom" "11sameNbr" "8cOnlyRatioDownFastSave" "19onlyFC" "19sameNbr" ) 


#TAD_DE_pipSteps=( "6fastSave" "5sameNbr" "9" "7sameNbr" "10sameNbr" "11sameNbr" "8cOnlyRatioDownFastSave" "19onlyFC" "19sameNbr" ) 
#TAD_DE_pipSteps=( "10sameNbrTopDom" )   # HACK HERE 22.08.20 to take the 
#TAD_DE_pipSteps=( "11sameNbr"  ) 

runDir="/mnt/etemp/marie/v2_TopDom_Cancer_HiC_data_TAD_DA"
