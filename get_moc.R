get_MoC <- function(file1, file2, chrSize=NULL, nCpu = 1, fillInter=TRUE, meanWithInter = FALSE, correctClust = FALSE, binSize = NA, noMinusOne = FALSE, fillInterGapZero = FALSE) {
...
get_MoC_dt <- function(dt1, dt2, chrSize=NULL, nCpu = 1, fillInter=TRUE, meanWithInter = FALSE, correctClust = FALSE, binSize = NA, noMinusOne = FALSE, fillInterGapZero = FALSE) {
  ...
  set1DT <- dt1
  stopifnot(colnames(set1DT) == c("chromo", "start", "end"))
  set2DT <- dt2
  stopifnot(colnames(set2DT) == c("chromo", "start", "end"))
