...
# ./3_assign_genes.sh ENCSR489OCU_NCI-H460
# ./3_assign_genes.sh ENCSR444WCZ_A549
# ./3_assign_genes.sh LG1
...
# Panc1_rep12/FINAL_DOMAINS/Panc1_rep12_chr12_TopDom_40kb_final_domains.txt
